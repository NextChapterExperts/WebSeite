      ...
      <div className="w-1/2 h-screen flex flex-col justify-center px-6 md:px-12 bg-gray-900 text-gray-100">
        ...
        >
          <motion.h2 variants={itemVariant} className="text-4xl font-bold mb-4">
            Coaching für SAP BTP
          </motion.h2>
          <motion.p variants={itemVariant} className="text-lg mb-6">
            Maximieren Sie Ihr Potenzial mit unserer Expertise.
          </motion.p>
          <motion.a
          ...
          <div className="flex flex-col md:flex-row md:space-x-6">
            ...
            >
              <h3 className="text-xl font-bold mb-2">Wissen das wirkt</h3>
              <p className="text-sm mb-4">Entdecken Sie unser Service-Portfolio für Ihren Erfolg.</p>
              <a
                href="/leistungen"
            ...
            >
              ...
              <p className="text-sm mb-4">Unser Ansatz für erfolgreiche Zusammenarbeit.</p>
              <a
                href="/team"
                className="inline-block bg-gray-900 text-gray-100 py-2 px-4 rounded-md"
              >
